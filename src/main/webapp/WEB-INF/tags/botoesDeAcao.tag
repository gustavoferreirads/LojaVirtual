...
<div class="form-actions-button">
    ...
    <button type="submit" class="btn btn-primary" onclick="submitNewForm();"><fmt:message key="label.salvar_novo"/></button>
    <button type="submit" class="btn btn-danger" disabled="${disabledRemove == true ? 'disabled': ''}" onclick="removeObject();"><fmt:message key="label.remover"/></button>
